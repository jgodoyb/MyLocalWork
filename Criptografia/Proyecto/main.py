...
def open_main_window():
    ...
    rsa_checkbox = ttk.Checkbutton(main_window, text="Usar RSA para cifrar la clave AES", variable=rsa_option)
    rsa_checkbox.grid(row=1, column=0, columnspan=2, padx=10, pady=10, sticky="w")
